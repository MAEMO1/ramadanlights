...
const dummyFoodPartners: FoodPartner[] = [
  ...
  // TAKEAWAY - Afhaalmaaltijden
  {
    ...
    name: "Snack Layla",
    slug: "snack-layla",
    description: "Snelle halal snacks en afhaalmaaltijden. Durum, pita, kapsalon en friet. Perfect voor een snelle hap na taraweeh.",
    address: "Bevrijdingslaan 100",
    city: "Gent",
    postal_code: "9000",
    latitude: 51.0420,
    longitude: 3.7350,
    category: "takeaway",
    cuisine_type: "turkish",
    dish_types: ["snacks", "grill", "shawarma"],
    is_halal_certified: true,
    halal_certification_info: null,
    partner_tier: "partner",
    tier_expires_at: null,
    iftar_special: "Ramadan Box - Kapsalon + drankje voor €10",
    iftar_special_price: "€10",
    contact_name: "Leyla",
    contact_email: "info@snacklayla.be",
    contact_phone: "+32 9 888 99 00",
    website_url: null,
    menu_url: null,
    reservation_url: null,
    facebook_url: "https://facebook.com/snacklayla",
    instagram_url: "https://instagram.com/snacklayla",
    uber_eats_url: null,
    deliveroo_url: "https://deliveroo.be/snacklayla",
    takeaway_url: "https://takeaway.com/snacklayla",
    logo_url: null,
    cover_image_url: null,
    opening_hours: null,
    status: "approved",
...
const dummyShopPartners: ShopPartner[] = [
  ...
  // JEWELRY - Juwelen
  {
    ...
    name: "Nour Jewels",
    slug: "nour-jewels",
    description: "Handgemaakte islamitische sieraden. Kalligrafie kettingen, gebedsarmbanden en elegant Eid cadeau.",
    address: "Langemunt 12",
    city: "Gent",
    postal_code: "9000",
    latitude: 51.0560,
    ...
    partner_tier: "partner_plus",
    tier_expires_at: null,
    ramadan_special: "Eid Collectie - Handgegraveerde kalligrafie kettingen",
    ramadan_special_discount: "Gratis gravure bij aankoop boven €75",
    contact_name: "Nour El-Amin",
    contact_email: "info@nourjewels.be",
    contact_phone: "+32 9 222 33 44",
    website_url: "https://example.com/nourjewels",
    facebook_url: "https://facebook.com/nourjewels",
    instagram_url: "https://instagram.com/nourjewels",
    logo_url: null,
    cover_image_url: null,
    opening_hours: null,
    status: "approved",
  ...
  // BOOKS - Boeken
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    name: "Dar Al-Ilm Boekhandel",
    slug: "dar-al-ilm",
    description: "Islamitische boeken, Korans, kinderboeken en educatief materiaal. Alles voor Ramadan en dagelijks leren.",
    address: "Brabantdam 88",
    city: "Gent",
    postal_code: "9000",
    latitude: 51.0510,
    longitude: 3.7280,
    ...
    partner_tier: "partner",
    tier_expires_at: null,
    ramadan_special: "Ramadan Leeslijst - Geselecteerde boeken over vasten en spiritualiteit",
    ramadan_special_discount: "3 boeken voor de prijs van 2",
    contact_name: "Ibrahim Hassan",
    contact_email: "info@daralilm.be",
    contact_phone: "+32 9 333 44 55",
    website_url: "https://example.com/daralilm",
    facebook_url: "https://facebook.com/daralilm",
    instagram_url: null,
    logo_url: null,
    cover_image_url: null,
    opening_hours: null,
  ...
  {
    id: "shop-electronics-1",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    name: "Smart Salah",
    slug: "smart-salah",
    description: "Slimme gebedstijd displays, digitale tasbih, en smart home verlichting voor Ramadan sfeer.",
    ...
    partner_tier: "partner",
    tier_expires_at: null,
    ramadan_special: "Smart Ramadan Kit - LED verlichting + gebedstijd display",
    ramadan_special_discount: "20% korting op smart home sets",
    contact_name: "Tariq Osman",
    contact_email: "info@smartsalah.be",
    contact_phone: "+32 9 444 55 66",
    website_url: "https://example.com/smartsalah",
    facebook_url: null,
    instagram_url: "https://instagram.com/smartsalah",
    logo_url: null,
    cover_image_url: null,
    opening_hours: null,
    status: "approved",
  ...
  // SPORTS - Sport
  {
    ...
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    name: "Halal Sports Gent",
    slug: "halal-sports",
    description: "Sportkleding en accessoires voor moslims. Bescheiden sportkleding, zwemkleding en fitnessuitrusting.",
    address: "Coupure Links 150",
    city: "Gent",
    postal_code: "9000",
    latitude: 51.0570,
    longitude: 3.7150,
    ...
    ramadan_special: null,
    ramadan_special_discount: null,
    contact_name: "Yassine Benali",
    contact_email: "info@halalsports.be",
    contact_phone: "+32 9 555 66 77",
    website_url: null,
    facebook_url: "https://facebook.com/halalsportsgent",
    instagram_url: "https://instagram.com/halalsportsgent",
    logo_url: null,
    cover_image_url: null,
    opening_hours: null,
    status: "approved",
