...
export default function BedanktActiviteitPage() {
  return (
        ...
        <div className="section-container">
          ...
          >
            ...
            <p className="text-xl text-white/70 mb-8 leading-relaxed">
              Uw activiteit is succesvol ingediend. We zullen uw inzending zo snel
              mogelijk beoordelen. U ontvangt een e-mail zodra uw activiteit is
              goedgekeurd.
            </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="text-left max-w-md mx-auto space-y-3">
                <li className="flex items-start gap-3 text-white/70">
                  ...
                  <span>Wij beoordelen uw activiteit binnen 24-48 uur</span>
                </li>
                <li className="flex items-start gap-3 text-white/70">
                  <span className="w-6 h-6 rounded-full bg-teal/20 text-teal flex items-center justify-center flex-shrink-0 text-sm font-bold">
                    2
                ...
                <li className="flex items-start gap-3 text-white/70">
                  ...
                  <span>Uw activiteit verschijnt op de &quot;Wat te doen&quot; pagina</span>
                </li>
              </ul>
            </div>
