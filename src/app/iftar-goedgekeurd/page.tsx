...
function IftarGoedgekeurdContent() {
    ...
    <main className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        >
          ...
          >
            {isApproved ? "Iftar Goedgekeurd!" : "Iftar Afgekeurd"}
          </motion.h1>
          ...
          >
            {already
              ? `Deze iftar was al ${isApproved ? "goedgekeurd" : "afgekeurd"}.`
              : isApproved
              ? "De iftar is succesvol goedgekeurd en verschijnt nu op de Iftarkaart."
              : "De iftar inzending is afgekeurd."}
          </motion.p>
          ...
          >
            <Button variant="secondary" size="md">
              <a href="/iftar" className="flex items-center gap-2">
...
export default function IftarGoedgekeurdPage() {
  return (
    <Suspense
      fallback={
