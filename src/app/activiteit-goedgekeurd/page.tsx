  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-white/70 mb-8 leading-relaxed">
        {already
          ? "Deze activiteit was al eerder verwerkt."
          : isApproved
            ? "De activiteit is succesvol goedgekeurd en is nu zichtbaar op de 'Wat te doen' pagina."
            : isRejected
              ? "De activiteit is afgekeurd."
...
export default function ActiviteitGoedgekeurdPage() {
  return (
